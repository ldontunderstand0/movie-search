    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countries', models.ManyToManyField(blank=True, related_name='movies', to='catalog.country', verbose_name='Страны')),
                ('genres', models.ManyToManyField(blank=True, related_name='movies', to='catalog.genre', verbose_name='Жанры')),
            ],
            options={
                'verbose_name': 'Кино',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='professions', to='catalog.movie', verbose_name='Кино')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='professions', to='catalog.person', verbose_name='Личность')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='person',
            name='movies',
            field=models.ManyToManyField(blank=True, related_name='movies', through='catalog.Profession', to='catalog.movie', verbose_name='Фильмы'),
        ),
        migrations.CreateModel(
            name='Rating',
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ratings', to='catalog.movie', verbose_name='Кино')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reviews', to='catalog.movie', verbose_name='Кино')),
