...
store.setResource('person', api.person.retrieve)
...
<div v-else-if="store.items" class="movie-detail-container">
    ...
    <div class="movie-header-section">
        <div class="movie-poster-section">
            <div class="movie-poster-wrapper">
                    <img v-if="store.items.photo" class="movie-poster-image" :src="store.items.photo" :alt="store.items.full_name">
        ...
        <div class="movie-main-info">
            <div class="movie-title-section">
                <h1 class="movie-main-title">{{ store.items.full_name }}</h1>
                ...
                <div class="info-table">
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <router-link :to="{name: 'movie', query: {year: store.items.birth_date.split('-')[0]}}" class="actor-link">
                                {{ store.items.birth_date.split("-")[0] }}
                            </router-link>
                        </div>
                    </div>
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <router-link :to="{name: 'person', query: {sex: store.items.sex}}" class="actor-link">
                                {{ store.items.sex }}
                            </router-link>
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="info-label">Количество фильмов</div>
                        <div class="info-value">
                            <router-link to="" class="actor-link">
                                {{ store.items.movies_count }}
                            </router-link>
                        </div>
                    </div>
                </div>
    ...
    <section class="description-section">
        ...
        <div v-else class="info-label">Нет биографии</div>
    </section>
