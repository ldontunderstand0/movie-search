...
store.setResource('genre', api.genre.list, api.genre.filter)
...
<template>
  <div class="movie-list-container">
    ...
    <div v-else class="pagination-info">
        ...
        <span class="total-count">{{ store.count }}</span> жанров
    </div>


    <Grid :items="store.items" routeName="movie" queryKey="genre" queryValueField="name" />
